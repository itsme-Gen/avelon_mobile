...
const slides = [
  {
    ...
    description:
      "Lend and borrow with confidence using a transparent, collateral-backed lending platform.",
  },
  {
    id: "2",
    logo: require("../../../assets/images/avelon_nobg.png"),
    ...
    description:
      "Built on Ethereum network to ensure secure transactions, decentralized control and global accessibility.",
  },
  {
    id: "3",
    logo: require("../../../assets/images/avelon_nobg.png"),
...
export default function LandingScreen() {
  ...
  // Auto-slide every 3 seconds (ping-pong: reverses at edges)
  useEffect(() => {
        ...
        {slides.map((_, index) => (
          <TouchableOpacity
            ...
            className={`h-3 rounded-full mx-1 ${
              index === currentIndex ? "w-8 bg-black" : "w-3 bg-gray-300"
            }`}
          />
        ))}
      </View>
