    ...
    return (
        <View className="flex-1 bg-gray-50">
            <ScrollView className="flex-1 px-6 py-8">
                ...
                {/* Progress Dots - Step 4 of 4 (or adjust totalSteps based on your flow) */}
            ...
            <View className="absolute bottom-0 left-0 right-0 bg-white px-6 py-4 border-t border-gray-200 flex-row gap-3">
                <TouchableOpacity 
